...
TEST_F(CounterTest, TestCounterName) {
  std::unique_ptr<GCMCounter<>> counter(GCMCounter<>::New("name", "help"));
...
TEST_F(CounterTest, TestCounterLabelNames) {
  std::unique_ptr<GCMCounter<string, string, int>> counter(
      GCMCounter<string, string, int>::New("name", "one", "two", "three",
                                           "help"));
...
TEST_F(CounterTest, TestCounterWithLabels) {
  std::unique_ptr<GCMCounter<std::string, int>> counter(
      GCMCounter<std::string, int>::New("name", "a string", "an int", "help"));
